...
struct P_motor_test_hierarchies_T_ {
  ...
  real_T enable_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T fullspeed_Value;              /* Expression: 255
                                        * Referenced by: '<Root>/fullspeed'
                                        */
 ...
 * '<S2>'   : 'motor_test_hierarchies/Motorensteuerung/hl'
 * '<S3>'   : 'motor_test_hierarchies/Motorensteuerung/hr'
 * '<S4>'   : 'motor_test_hierarchies/Motorensteuerung/vl'
 * '<S5>'   : 'motor_test_hierarchies/Motorensteuerung/vr'
 * '<S6>'   : 'motor_test_hierarchies/Motorensteuerung/hl/M'
 * '<S7>'   : 'motor_test_hierarchies/Motorensteuerung/hl/PWM E'
 * '<S8>'   : 'motor_test_hierarchies/Motorensteuerung/hr/Digital Output M'
 * '<S9>'   : 'motor_test_hierarchies/Motorensteuerung/hr/PWM E'
 * '<S10>'  : 'motor_test_hierarchies/Motorensteuerung/vl/M'
 * '<S11>'  : 'motor_test_hierarchies/Motorensteuerung/vl/PWM E'
 * '<S12>'  : 'motor_test_hierarchies/Motorensteuerung/vr/Digital Output'
 * '<S13>'  : 'motor_test_hierarchies/Motorensteuerung/vr/PWM'
 */
