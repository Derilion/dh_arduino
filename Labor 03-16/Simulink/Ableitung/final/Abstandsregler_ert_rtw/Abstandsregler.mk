###########################################################################
## Makefile generated for Simulink model 'Abstandsregler'. 
## 
## Makefile     : Abstandsregler.mk
## Generated on : Wed Mar 23 16:39:10 2016
## MATLAB Coder version: 3.0 (R2015b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Abstandsregler.elf
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = Abstandsregler_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Abstandsregler.elf
...
DEFINES_STANDARD = -DMODEL=Abstandsregler -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO
...
%.o : $(START_DIR)/Abstandsregler_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Abstandsregler_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/Abstandsregler_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
