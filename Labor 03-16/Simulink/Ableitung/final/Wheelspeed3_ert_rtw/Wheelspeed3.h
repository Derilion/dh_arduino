...
/* Block signals for system '<Root>/Subsystem1' */
typedef struct {
  real_T Divide;                       /* '<S7>/Divide' */
} B_Subsystem1_Wheelspeed3_T;

/* Block states (auto storage) for system '<Root>/Subsystem1' */
typedef struct {
  real_T Delay1_DSTATE;                /* '<S7>/Delay1' */
  int8_T Subsystem1_SubsysRanBC;       /* '<Root>/Subsystem1' */
} DW_Subsystem1_Wheelspeed3_T;

/* Zero-crossing (trigger) state for system '<Root>/Subsystem1' */
typedef struct {
  ZCSigState Subsystem1_Trig_ZCE;      /* '<Root>/Subsystem1' */
} ZCE_Subsystem1_Wheelspeed3_T;
...
typedef struct {
  ...
  B_Subsystem1_Wheelspeed3_T Subsystem7;/* '<Root>/Subsystem7' */
  B_Subsystem1_Wheelspeed3_T Subsystem3;/* '<Root>/Subsystem3' */
  B_Subsystem1_Wheelspeed3_T Subsystem2;/* '<Root>/Subsystem2' */
  B_Subsystem1_Wheelspeed3_T Subsystem1;/* '<Root>/Subsystem1' */
...
typedef struct {
  ...
  DW_Subsystem1_Wheelspeed3_T Subsystem7;/* '<Root>/Subsystem7' */
  DW_Subsystem1_Wheelspeed3_T Subsystem3;/* '<Root>/Subsystem3' */
  DW_Subsystem1_Wheelspeed3_T Subsystem2;/* '<Root>/Subsystem2' */
  DW_Subsystem1_Wheelspeed3_T Subsystem1;/* '<Root>/Subsystem1' */
...
typedef struct {
  ZCE_Subsystem1_Wheelspeed3_T Subsystem7;/* '<Root>/Subsystem1' */
  ZCE_Subsystem1_Wheelspeed3_T Subsystem3;/* '<Root>/Subsystem1' */
  ZCE_Subsystem1_Wheelspeed3_T Subsystem2;/* '<Root>/Subsystem1' */
  ZCE_Subsystem1_Wheelspeed3_T Subsystem1;/* '<Root>/Subsystem1' */
...
/* Parameters for system: '<Root>/Subsystem1' */
struct P_Subsystem1_Wheelspeed3_T_ {
  real_T n_Y0;                         /* Computed Parameter: n_Y0
                                        * Referenced by: '<S7>/n'
                                        */
...
struct P_Wheelspeed3_T_ {
  ...
  boolean_T Constant_Value_m;          /* Computed Parameter: Constant_Value_m
                                        ...
                                        */
  P_Subsystem1_Wheelspeed3_T Subsystem7;/* '<Root>/Subsystem7' */
  P_Subsystem1_Wheelspeed3_T Subsystem3;/* '<Root>/Subsystem3' */
  P_Subsystem1_Wheelspeed3_T Subsystem2;/* '<Root>/Subsystem2' */
  P_Subsystem1_Wheelspeed3_T Subsystem1;/* '<Root>/Subsystem1' */
 ...
 * '<S7>'   : 'Wheelspeed3/Subsystem1'
 * '<S8>'   : 'Wheelspeed3/Subsystem2'
 * '<S9>'   : 'Wheelspeed3/Subsystem3'
 * '<S10>'  : 'Wheelspeed3/Subsystem7'
