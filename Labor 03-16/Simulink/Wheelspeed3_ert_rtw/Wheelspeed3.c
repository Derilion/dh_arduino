...
void Wheelspeed3_step(void)
{
  ...
  srClearBC(Wheelspeed3_DW.Subsystem3_SubsysRanBC);
  ...
  /* Outputs for Triggered SubSystem: '<Root>/Subsystem3' incorporates:
   *  TriggerPort: '<S7>/Trigger'
   */
  if (rtb_FixPtRelationalOperator && (Wheelspeed3_PrevZCX.Subsystem3_Trig_ZCE !=
       POS_ZCSIG)) {
     ...
     *  Sum: '<S7>/Add1'
     */
    Wheelspeed3_B.Divide = Wheelspeed3_P.Constant_Value / (Wheelspeed3_B.Clock -
      Wheelspeed3_DW.Delay1_DSTATE);

    /* Update for Delay: '<S7>/Delay1' */
    Wheelspeed3_DW.Delay1_DSTATE = Wheelspeed3_B.Clock;
    Wheelspeed3_DW.Subsystem3_SubsysRanBC = 4;
  }

  Wheelspeed3_PrevZCX.Subsystem3_Trig_ZCE = rtb_FixPtRelationalOperator;
...
void Wheelspeed3_initialize(void)
{
  ...
  rtmSetTFinal(Wheelspeed3_M, 100.0);
  Wheelspeed3_M->Timing.stepSize0 = 0.01;

  /* External mode info */
  Wheelspeed3_M->Sizes.checksums[0] = (1663990498U);
  Wheelspeed3_M->Sizes.checksums[1] = (1993100387U);
  Wheelspeed3_M->Sizes.checksums[2] = (2589927365U);
  Wheelspeed3_M->Sizes.checksums[3] = (2042361232U);

  {
    ...
    systemRan[9] = (sysRanDType *)&Wheelspeed3_DW.Subsystem3_SubsysRanBC;
  ...
  /* VirtualOutportStart for Outport: '<S7>/dPhi' */
  Wheelspeed3_B.Divide = Wheelspeed3_P.dPhi_Y0;
  ...
  Wheelspeed3_PrevZCX.Subsystem3_Trig_ZCE = POS_ZCSIG;
  ...
  Wheelspeed3_DW.Delay1_DSTATE = Wheelspeed3_P.Delay1_InitialCondition;
