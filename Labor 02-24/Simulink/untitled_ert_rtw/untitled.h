...
struct P_untitled_T_ {
  real_T RepeatingSequenceStair_OutValue[6];/* Mask Parameter: RepeatingSequenceStair_OutValue
 ...
 * '<S2>'   : 'untitled/Repeating Sequence Stair/LimitedCounter'
 * '<S3>'   : 'untitled/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S4>'   : 'untitled/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 */
