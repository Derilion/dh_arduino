...
%   % PDF Informationen
%   pdftitle={},             % Titel
   pdfauthor={Maximilian Alexander Bier},            % Autor
...
\clearscrplain
%
\newboolean{isArabic} %Deklaration
\setboolean{isArabic}{false}
% Was steht wo...
...
%    \ohead{\headmark} % Oben außen: Setzt Kapitel und Section automatisch
   ...
   %\ihead{\headmark}
   \ihead
{\small{Sicherheits- \& Fahrerassistenzsysteme\\
   	Laborbericht 2}}
   \ohead{
   	\includegraphics[height=1cm]{images/dhbw}
}
   	\ifoot	{{\tiny PEA4-Fe \textendash{} betriebliche Ausbildung technische Studiengänge der DHBW \textendash{} \modul\\}
   			{\small\begin{tabularx}{\textwidth}{lXr}Stand \today && Seite \pagemark~von \ifthenelse{\boolean{isArabic}}{\pageref{LastPage}}{\pageref{endRoman}}
   			\end{tabularx}}
   		}  	
%	}{
%	\ifoot	{{\tiny PEA4-Fe \textendash{} betriebliche Ausbildung technische Studiengänge der DHBW \textendash{} \modul\\
%		\copyright~ Alle Rechte bei Robert Bosch GmbH, auch für den Fall von Schutzrechtsanmeldungen. Jede Verfügungsbefugnis, wie Kopier- und Weitergaberecht bei uns.\\}
%		\vspace{0.3cm}
%		{\small\begin{tabularx}{\textwidth}{lXr}Stand 20. Januar 2016 && Seite \pagemark~von \MakeUppercase{\romannumeral{\pageref{endRoman}}}
%		\end{tabularx}}
%	}
%}
%\ihead{
%	\small Personalentwicklung und Ausbildung Feuerbach\\
%	Technische Studiengänge an der DHBW}
%\ohead{\includegraphics[height=1cm]{images/dhbw.pdf}}
...
\titleformat{\chapter}[display]	% {command}[shape]
  ...
  {   										% label
  \LARGE\MakeUppercase{\bfseries{\chaptertitlename}} \Huge \thechapter \filright%
  }%}
  {0pt}										% sep (from chapternumber)
  {\vspace{0.9pc} \filright \color{sectioncolor}}   % {before}[after] (before chaptertitle and after)
  %[\color{black} \vspace{0.9pc} \filright]
